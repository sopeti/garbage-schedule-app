...
const ja: Translations = {
  ...
  saved: '保存しました',
  notificationsScheduled: '通知を設定しました',
  reminderTimes: '通知タイミング',
  eveningBefore: '前晩',
  morningOf: '当日朝',
  language: '言語',
  headline: 'ゴミ出し\nカレンダー',
  subtitle: '地区を選ぶだけで、ごみの収集日をお知らせします。',
  ...
  notifMorningBody:  (emoji) => `${emoji} 8時までにお出しください`,
}
...
const en: Translations = {
  ...
  morningOf: 'Collection Day Morning',
  language: 'Language',
  headline: 'Garbage\nCalendar',
